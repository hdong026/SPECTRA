...
from ...metrics import masked_mae, masked_rmse, masked_mape, masked_mape_10


class STNormRunner(BaseTimeSeriesForecastingRunner):
    ...
    def __init__(self, cfg: dict):
        ...
        self.metrics = {"MAE": masked_mae, "RMSE": masked_rmse, "MAPE": masked_mape_10}
